...
import {createGame,startGame,stepGame,triggerPursuit,interact,makeVehicle} from '../src/simulation.js';
...
test('player can drive away while the two responding police cars wait',()=>{
 ...
 assert.ok(g.police.every((c,i)=>distance(c,positions[i])<.01));
