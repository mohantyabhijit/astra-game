...
import {circuit,gems,projectSegment} from '../src/district.js';
import {writeFileSync} from 'node:fs';
// Input-only lap on a profile whose gems are already collected. Traffic and damage stay enabled.
const game=createGame(gems.map(g=>g.id));startGame(game);let index=1;
